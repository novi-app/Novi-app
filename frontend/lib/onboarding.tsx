...
export const ACTIVITY = [
  { value: "food",    label: "Food",    description: "From street eats to sit-down spots" },
  { value: "social",  label: "Social",  description: "Bars, people, and late nights"      },
  { value: "explore", label: "Explore", description: "Hidden corners and open streets"    },
];
